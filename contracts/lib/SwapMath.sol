...
library SwapMath {
  function computeSwapStep(
    ...
    if (zeroForOne) {
      ...
      amountOut = Math.calcAmount1Delta(sqrtPriceNextX96, sqrtPriceTargetX96, liquidity, false);
    } else {
      amountIn = max ? amountIn : Math.calcAmount1Delta(sqrtPriceCurrentX96, sqrtPriceNextX96, liquidity, true);
      amountOut = Math.calcAmount0Delta(sqrtPriceNextX96, sqrtPriceTargetX96, liquidity, false);
    }
